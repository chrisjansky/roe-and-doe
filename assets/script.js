...
function getCookie(cname) {
    ...
    if(getCookie("bg") == 1){
      $( "#content" ).css("background-image", "url(../images/background.png)");
      bg = 1;
    }
    else if(getCookie("bg") == 2){
      $( "#content" ).css("background-image", "url(../images/background_2.jpg)");
      bg = 2;
    }
    else if(getCookie("bg") == 3){
      $( "#content" ).css("background-image", "url(../images/background_3.jpg)");
      bg = 3;
    }
    if(getCookie("bryl") == "nie"){
      ...
      $( "#bryle" ).css("background-image", "url(../images/glasses_2.png)");
      bryle = 2;
    }
      ...
      $( "#bryle" ).css("background-image", "url(../images/glasses.png)");
      bryle = 1;
    }
    if(getCookie("out") == 2){
      ...
      $( "#outfit" ).css("background-image", "url(../images/outfit_new_2.png)"); 
      ...
      $( "#outfit" ).css("background-image", "url(../images/outfit_new_3.png)");
      outfit = 3;
    }
      ...
      $( "#outfit" ).css("background-image", "url(../images/outfit_new_4.png)");
      outfit = 4;
    }
      ...
      // $( "#menu, #content" ).css("min-height", "800px");       
      $( "#outfit" ).css("background-image", "url(../images/outfit_new_1.png)");
...
$("#make_outfit").click(
  function() {
    $("#podmenu_game_shortcut").add(".game-buttons").css("visibility", "visible");
  });
